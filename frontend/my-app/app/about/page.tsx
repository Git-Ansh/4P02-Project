...
.afbiWrap {
  ...
  --bg: #ffffff; --bg2: #f8f5f0; --bg3: #f0ece4;
...
.dark .afbiWrap {
  ...
  --bg: #080809; --bg2: #101013; --bg3: #161619;
  --card: #121215; --card2: #191920;
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="afbiWrap outfit flex-1"
        ...
        {/* ------------ CTA --------- */}
        <section className="relative text-center py-32 px-12 overflow-hidden" style={{ background: "var(--bg)", transition: "background .4s ease" }}>
          <div className="absolute inset-0 pointer-events-none"
               style={{ background: "radial-gradient(ellipse 60% 60% at 50% 50%,var(--accentGlow),transparent 65%)" }} />
          <div className="relative max-w-[1240px] mx-auto">
            <TagLine label="Get in touch" center />
            ...
            <p className="reveal mx-auto mt-6 mb-10 text-base max-w-xl" style={{ color: "var(--muted)" }}>
              Reach out to learn how Academic FBI can join with your institution's workflow.
            </p>
